...
# ax[0].scatter(X[:, 1], X[:, 2], c=color, cmap=plt.cm.Spectral)
...
# x_min, x_max = X_train_lda[:,1].min() - 1, X_train_lda[:,0].max() + 1
...
# data = {
#  'Height': [170, 165, 187, 175, 163, 122, 168, 177, 162, 158],
#  'Weight': [65, 59, 75, 62, 55, 70, 62, 74, 58, 54],
#  'Age': [20, 55, 25, 27, 28, 32, 27, 33, 24, 21],
...
# plt.axis('off')
# plt.tittle('original gray scale image')
# plt.show()
