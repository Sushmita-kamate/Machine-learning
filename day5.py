...
# # PART 2: Making the data distributions
# x = pd.DataFrame({
#     'x1': np.concatenate([np.random.normal(10, 2, 1000),np.random.normal(2, 2, 20)]),
#     'x2': np.concatenate([np.random.normal(20, 1, 1000),np.random.normal(30, 1, 20)])
# })
...
# X_normalized = X.copy()
# X_normalized[features] = minmax_scaler.fit_transform(X[features])

# # Z-score Standardization
# standard_scaler = StandardScaler()
# X_standardized = X.copy()
# X_standardized[features] = standard_scaler.fit_transform(X[features])
